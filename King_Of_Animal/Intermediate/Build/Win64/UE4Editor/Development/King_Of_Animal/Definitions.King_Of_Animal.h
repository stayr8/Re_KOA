...
#define UE_PROJECT_NAME King_Of_Animal
#define UE_TARGET_NAME King_Of_AnimalEditor
#define UE_MODULE_NAME "King_Of_Animal"
...
#define KING_OF_ANIMAL_API DLLEXPORT
